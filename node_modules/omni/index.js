...
module.exports = function Actions (id, template) { // >>>>>>>>>>>>>>>>>>>>>>>>>
  ...
  var grifter = {
    ...
    parse : function (e) {
      ...
      if (t.className.match('editBox') || t.className.match('dropzone')) {
      ...
      this.live = true
      this.target = t
      this.bounds.x = t.getBoundingClientRect().left + 'px'
      this.bounds.y = t.getBoundingClientRect().top + 'px'
      this.bounds.h = t.offsetHeight + 'px'
      this.bounds.w = t.offsetWidth + 'px'
  ...
  // var moduleID = utils.climb(e.target)
  // s.push({from:id, key:'get', value:'module:'+moduleID})
  ...
  function contextMenu (e) { 
    ...
    // on exec get data for selected element & map/replace
    var moduleID = utils.climb(e.target)
    s.push({from:id, key:'get', value:'module:'+moduleID})
    s.push({from:id, key:'put', value:{key:'module:'+moduleID}, val:''})
  }
