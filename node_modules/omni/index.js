...
module.exports = function Actions (C) {
  ...
  function inputCmd (e) {
    ...
    if (res) { // preview res
      // show results & tab to act on them
    } else omni._ = null
  ...
  function ctx (e) {  // default image loading / temp thing!?
    e.preventDefault()
  ...
  function fileUpload (e) {
    e.preventDefault()
    console.log(e.target) // dropped node -- process with ctx
    var files = []
