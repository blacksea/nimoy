...
module.exports = function Omni (opts) {
  ...
  // BIND INPUT / TEXTAREA TO THIS!
  if (e.dataTransfer.files.length > 0) {
    editor.erase()
    upload(e, blob, function (d) { // call editOut?!
  ...
  function rightClickGrifter (e) { // CONTEXT CLICK -- DROMPII
    cancel(e)
    blob = {}
    metaBlob = {}
    editor.erase()
...
function buildUI () {
  ...
  function cutCvs(h){console.log(h);document.querySelector('.omni').style.height = h+'px'}
