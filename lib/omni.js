...
module.exports = function Omni (opts) {
  ...
  function initUI () {
    ...
    ui.makeBox = function (name,pos) {
      ...
      var nb = new pj.Group({ children : [frame,label] })
  ...
  var omni = new D({ 
    ...
    events : [
      ...
      ['.log','click',toggleCanvas],
      ['.log','selectstart',cancel],
      ['.oz','keyup',keyInput]
    ]
  })
  ...
  function toggleCanvas (e) {
    ...
    if (dx.w !== '0px') {
      ...
      dx.h = '0px'
      omni.draw(dx)
      e.target.style.color = '#DBB8BF'
    } else {
      dx.w = '100%'
      dx.h = '100%'
      omni.draw(dx)
      e.target.style.color = '#67B9FE'
    }
  }
