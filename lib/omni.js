...
var STATUS = fs.readFileSync(__dirname+'/status.hogan', 'utf8')
var LOGIN = fs.readFileSync(__dirname+'/login.hogan', 'utf8') 


// set a login mode ?! // draw to top of page!
  ...
  function upload (e) {
    ...
    for (file in files) {
      ...
      reader.addEventListener('load', function (data) {
        blob.data[_.keys(blob.edit)[0]] = '/files/'+fileName
        s.push({key:'+$'+blob.id,value:blob.data})
        editor.erase()
