...
// figure out the saving / update process!
// load on page load -- prefill the cvs bar and update on new frames
...
module.exports = function Omni (opts) {
  ...
  function drawBones (d) { 
    // change to just new frame or something
    // save the current selected cvs slot
